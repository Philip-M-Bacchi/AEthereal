...
public protocol ChainableSpecifier {
    ...
    func byID(_ wantType: AE4.AEType, _ id: Encodable) -> ObjectSpecifier
    func byRange(_ wantType: AE4.AEType, from: Encodable, thru: Encodable) -> ObjectSpecifier
...
extension ObjectSpecifier: ChainableSpecifier {
    ...
    public func byID(_ wantType: AE4.AEType, _ id: Encodable) -> ObjectSpecifier {
        ObjectSpecifier(parent: .objectSpecifier(self), wantType: wantType, selectorForm: .id(id))
    }
    public func byRange(_ wantType: AE4.AEType, from: Encodable, thru: Encodable) -> ObjectSpecifier {
...
extension ObjectSpecifier {
    ...
    public func beginsWith(_ value: Encodable) -> TestClause {
        .comparison(operator: .beginsWith, lhs: self, rhs: value)
    }

    public func endsWith(_ value: Encodable) -> TestClause {
        .comparison(operator: .endsWith, lhs: self, rhs: value)
    }

    public func contains(_ value: Encodable) -> TestClause {
        .comparison(operator: .contains, lhs: self, rhs: value)
    }

    public func isIn(_ value: Encodable) -> TestClause {
        .comparison(operator: .contains, lhs: value, rhs: self)
    }
    
}

public func <(lhs: ObjectSpecifier, rhs: Encodable) -> ObjectSpecifier.TestClause {
